...
const categoryData = {
    "Men's Singles": {
        playerData : [
            { name: "Player A", team: "Team X", level: 5, points: 50 },
            { name: "Player B", team: "Team Y", level: 3, points: 30 },
            { name: "Player C", team: "Team Z", level: 8, points: 80 },
        ],
        teamData: [],
        matchData: [
            {
...
export default TTCategoryDetails;
